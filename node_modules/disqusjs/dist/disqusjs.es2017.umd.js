(function (global, factory) {
  ...
  const DisqusJSLoadMoreCommentsButton = /*#__PURE__*/ E((props)=>{
      ...
      return /*#__PURE__*/ e("a", _objectSpreadProps(_objectSpread({}, restProps), {
          id: "dsqjs-load-more",
  ...
  function DisqusJSPostItem(props) {
      ...
      return /*#__PURE__*/ e("li", {
          ...
          children: [
              ...
              /*#__PURE__*/ e(DisqusJSChildrenPostItems, _objectSpreadProps(_objectSpread({}, props), {
  ...
  function DisqusJSChildrenPostItems(props) {
      ...
      return /*#__PURE__*/ e("ul", {
          ...
          children: props.children.map((comment)=>/*#__PURE__*/ h$1(DisqusJSPostItem, _objectSpreadProps(_objectSpread({}, comment), {
                  admin: props.admin,
  ...
  const DisqusJSCommentsList = (props)=>{
      ...
      return /*#__PURE__*/ e("ul", {
          ...
          children: processedComments.map((comment)=>/*#__PURE__*/ h$1(DisqusJSPostItem, _objectSpreadProps(_objectSpread({}, comment), {
                  key: comment.comment.id,
                  admin: props.admin,
                  adminLabel: props.adminLabel
              })))
      ...
      if (thread.response.length === 1) {
          ...
          return /*#__PURE__*/ e(p$1, {
              children: [
                  ...
                  /*#__PURE__*/ e(DisqusJSPosts, _objectSpreadProps(_objectSpread({}, props), {
  ...
  class DisqusJS {
      render(el) {
          ...
          if (container) {
              ...
              P$1(/*#__PURE__*/ e(DisqusJS$1, _objectSpread({}, this.config)), container);
          }
      }
      destroy() {
          if (this.container) {
