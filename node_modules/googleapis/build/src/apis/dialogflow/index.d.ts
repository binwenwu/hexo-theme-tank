...
export declare const VERSIONS: {
    ...
    v3alpha1: typeof dialogflow_v3alpha1.Dialogflow;
};
...
export declare function dialogflow(version: 'v3alpha1'): dialogflow_v3alpha1.Dialogflow;
export declare function dialogflow(options: dialogflow_v3alpha1.Options): dialogflow_v3alpha1.Dialogflow;
